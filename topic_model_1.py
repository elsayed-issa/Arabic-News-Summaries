...
df_dominant_topic['Text'].to_csv('ss.csv',sep='\t',header=True,index=False,encoding='utf-8')
# save to file
#df_dominant_topic.columns['Text'].to_csv('dominant_topics_lda.csv', sep='\t', header=True, index=False, encoding='utf-8')
